/**
 THIS WAS WAS TAKEN FROM: /projects/mediainfo-?.?.?.?/Developpers/Source/MediaInfoDLL/MediaInfoDLL.java
 1) Renamed to MediaInfo.java
 2) Added 'package' statement
 3) Add 'public' to class declaration
 */
